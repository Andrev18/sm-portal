...
const HeroCommand = () => {
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto px-6 py-12 lg:py-20 mt-4 mb-4 z-10">
      ...
      {/* Tło hero: grywalizacja, proste barwy */}
      ...
      >
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-wider mb-6">
          ...
          <span>Nowy Wynik do Pobicia!</span>
        </div>
        ...
        <p className="text-lg text-textSecondary mb-10 max-w-xl leading-relaxed">
          Utrzymujesz niesamowitą passę! Masz dzisiaj dokładnie <b>142</b> fiszki do powtórzenia przed wolnym wieczorem. Zbierz potrzebne XP i odblokuj kolejny poziom.
        </p>
        
        <div className="flex flex-wrap items-center gap-4">
          <button className="group flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-black font-bold hover:bg-white/90 transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(255,255,255,0.1)]">
            <Play className="w-5 h-5 fill-black" />
            <span>Graj i Ucz się</span>
          </button>
